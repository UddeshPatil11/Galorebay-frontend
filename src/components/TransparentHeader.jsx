		...
		<>
			<header className="w-full fixed z-20 top-8">
				<div className="w-[85%] mx-auto">
					<div className="bg-[#ECECEC] bg-opacity-50 backdrop-blur rounded-full px-6 py-2 shadow-[0_0_12px_-5px_#00000040]">
						<Link to="/" className="hidden lg:block">
							<img src="/images/1735878600.png" alt="" className="max-w-32 mx-auto" />
						</Link>
